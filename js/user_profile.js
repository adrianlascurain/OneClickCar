  ...
  fetch(
    ...
    .then((dataUser) => {
      ...
      if (dataUser.length > 0) {
        // idUserTextNew.value="";
        //   fullNameTextNew.value="";
        //   phoneNumberTextNew.value="";
        //   emailTextNew.value="";
        //   birthDateTextNew.value="";
        //   typeUserTextNew.value="";
          createTableAdmFetch();
...
function addUserAdmFetch() {
  ...
  const raw = JSON.stringify({
          ...
          phoneNumber: phoneNumberTextAdd.value,
...
if (userData.typeUser == "admin") {
  ...
  let birthdayUsertxt = document.getElementById("birthday-ipt");
  let phoneUsertxt = document.getElementById("telefono-ipt");
  nameUserTxt.value = userData.fullName;
  emailUserTxt.value = userData.email;
  birthdayUsertxt.value = userData.birthDate;
  phoneUsertxt.value = userData.phoneNumber;
